...
| Governance approve/deny from the UI | **NOT YET** | `gov` widget is display-only (denial counters); real approval flows live in the Python harness/`sp` CLI — cross-language approval is roadmap |
