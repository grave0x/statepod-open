SwarmState Node (Windows)

Double-click start_node.bat to launch the SwarmState node and open its local web dashboard (http://127.0.0.1:8080).
...
Details
- swarmstate-node.exe   the node (mesh daemon + web UI, self-contained)
- swarmstate-kernel.dll the precompiled SwarmState kernel (v0.3.0)
