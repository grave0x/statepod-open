...
Because LoRa is broadcast, the mesh requires an extra AES-256-GCM layer; the SwarmState simulator already uses optional shared-PSK AES-256-GCM with a 12-byte `os.urandom` nonce prepended over CBOR (simulator path done; real radio still open).[S19] AES-GCM security collapses on IV/nonce reuse under one key: confidentiality becomes a two-time pad and authenticity can fail via GHASH-key recovery, so uniqueness is nearly as critical as key secrecy (NIST: repeat probability ≤ 2⁻³²; guard power-loss IV repetition).[S20]
...
## Sources
- [S1] "agent-mesh (C99 CRDT mesh) README" — "/home/grave/Projects/internal.source/02-tools/mesh/README.md" (independently checked against "agent-mesh README + SwarmState meshd/adversarial-review" — "/home/grave/Projects/internal.source/02-tools/mesh/README.md")
...
- [S7] "SwarmState spec.md §7 Inference Engine" — "/home/grave/Projects/internal.source/02-tools/swarmstate/spec.md" (independently checked against "SwarmState spec.md §7 / embedded-inference-handler-spec-v1 / GAPS.md" — "/home/grave/Projects/internal.source/02-tools/swarmstate/spec.md")
- [S8] "swarmstate-node.c embedded inference queue" — "/home/grave/Projects/internal.source/02-tools/swarmstate/win/swarmstate-node.c"
- [S9] "GAPS.md Embedded inference status" — "/home/grave/Projects/internal.source/02-tools/swarmstate/GAPS.md"
- [S10] "GAPS.md GPU auto-tune / NGL policy" — "/home/grave/Projects/internal.source/02-tools/swarmstate/GAPS.md"
- [S11] "SwarmState README Embedded inference" — "/home/grave/Projects/internal.source/02-tools/swarmstate/README.md" (independently checked against "SwarmState README Embedded inference + GAPS.md + llama_infer.c" — "/home/grave/Projects/internal.source/02-tools/swarmstate/README.md")
- [S12] "swarmstate_memory_export Ollama operational notes" — "/home/grave/Documents/swarmstate_memory_export.md"
- [S13] "SwarmState redteam findings — WEAK W1" — "/home/grave/Projects/internal.source/02-tools/swarmstate/docs/redteam-findings.md"
- [S14] "SwarmState harness/governance.py token API" — "/home/grave/Projects/internal.source/02-tools/swarmstate/harness/governance.py"
- [S15] "Federation multi-homing spec — invite hardening F.2" — "/home/grave/Projects/internal.source/02-tools/swarmstate/docs/federation-multihoming-spec.md"
- [S16] "Phase 4 security gate status" — "/home/grave/Projects/internal.source/02-tools/swarmstate/docs/phase4-security-gate.md"
- [S17] "SwarmState Mesh Integration Specification §6.2" — "/home/grave/Projects/internal.source/02-tools/swarmstate/docs/documentation-mesh-spec.md"
...
- [S19] "SwarmState LoRa AES-GCM implementation + mesh-spec v2 §7.2" — "/home/grave/Projects/internal.source/02-tools/swarmstate/harness/lora.py"
...
- "Question 3 uncertainty: No SwarmState/agent-mesh repository document inspected here prescribes adopting FIDO2/WebAuthn as mesh join or governance-token auth for the C99 kernel + Python harness."
...
- "Question 4 uncertainty: SwarmState LoRa AES-GCM uses random 12-byte nonces; whether field-scale traffic will approach NIST’s RBG-IV birthday/invocation limits, or whether hardware will need persistent senderID||counter nonces, is not measured in-repo."
...
- "Question 4 uncertainty: How Meshtastic PHY/SDR replay and NodeDB/TOFU eviction attacks map onto SwarmState’s allowlist + CRDT op model was not directly evidenced in inspected sources."
- "Question 4 uncertainty: Real SwarmState LoRa radio hardware remains unimplemented (simulator only), so hardware entropy, SPI/DMA corruption, and secure PSK storage pitfalls are not yet empirically validated for this codebase."
