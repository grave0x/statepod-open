...
Re-pull anytime with the deepseek-export tool (sibling project
`../deepseek-export/`): `python3 deepseek_export.py pull <title-substring> --out DIR`.
Note: browser Downloads `chat.deepseek.com_*.{md,jsonl}` exports are sidebar
title lists, not transcripts.
